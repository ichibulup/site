...
function Sidebar({
  ...
  // During SSR or initial hydration, render desktop version to match server
  if (isMobile === true) {
    return (
...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      ...
      className={cn(
        "text-sidebar-foreground/70 ring-sidebar-ring flex h-9 shrink-0 items-center rounded-md px-2 text-xs font-medium outline-hidden transition-[margin,opacity] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
  ...
  ].join(" "),
  {
    variants: {
      variant: {
        default: "hover:bg-sidebar-accent hover:text-sidebar-accent-foreground",
        outline:
          "bg-background shadow-[0_0_0_1px_hsl(var(--sidebar-border))] data-[active=false]:hover:bg-sidebar-accent data-[active=false]:hover:text-sidebar-accent-foreground data-[active=false]:hover:shadow-[0_0_0_1px_hsl(var(--sidebar-accent))]",
      },
      size: {
        default: "h-9 text-sm",
        sm: "h-7 text-xs",
  ...
  return (
    <ul
      ...
      className={cn(
        ...
        // "mx-3.5 flex min-w-0 flex-col gap-1 pl-5 py-0.5",
        "group-data-[collapsible=icon]:hidden",
        className
      )}
      {...props}
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        "data-[active=true]:text-sidebar-accent-foreground data-[active=true]:bg-muted",
        size === "sm" && "text-xs",
        size === "md" && "text-sm",
        "group-data-[collapsible=icon]:hidden",
        className
